...
public class ApplicationStartupBootstrapper : IApplicationStartupBootstrapper
{
    ...
    public void HandleException(Exception e)
    {
        ...
        else if (e is ObjectDisposedException objectDisposedException &&
                 (objectDisposedException.Source == nameof(Autofac)))
        {
            _logger.LogTrace(
                e,
    ...
    void LogAndShowMessage(Message message)
    {
        if (message.Exception is OperationCanceledException ||
            (message.Exception is ObjectDisposedException objectDisposedException &&
             (objectDisposedException.Source == nameof(Autofac))))
        {
            return;
        }
