    ...
    where T : IEntity<TId>
{
    ...
    public IReadOnlyCollection<T> Find(Expression<Func<T, bool>> predicate, int pageNumber = 0, int pageSize = int.MaxValue) => Enumerate(predicate, pageNumber, pageSize).ToArray();
