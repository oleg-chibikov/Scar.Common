...
namespace Scar.Common.WPF.Controls.Behaviors
{
    public class ListBoxAutoScrollBehavior
    {
        ...
        public static readonly DependencyProperty ScrollOnNewItemProperty = DependencyProperty.RegisterAttached(
            "ScrollOnNewItem",
            typeof(bool),
            typeof(ListBoxAutoScrollBehavior),
            new UIPropertyMetadata(false, OnScrollOnNewItemChanged));

        public static bool GetScrollOnNewItem([NotNull] DependencyObject obj)
        {
            return (bool)obj.GetValue(ScrollOnNewItemProperty);
        }

        public static void SetScrollOnNewItem([NotNull] DependencyObject obj, bool value)
        {
        ...
        private sealed class Capture : IDisposable
        {
            ...
            public Capture([NotNull] ListBox listBox)
            {
                _listBox = listBox;
            ...
            private void incc_CollectionChanged(object sender, [NotNull] NotifyCollectionChangedEventArgs e)
            {
